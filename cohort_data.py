...
def find_cohort_by_student_name(student_list):
    ...
    if user_input == all_students_tuple_list(filename)[0]:
        print "{} was in the {} cohort".format(user_input,all_students_tuple_list(filename)[-1])
    else:
